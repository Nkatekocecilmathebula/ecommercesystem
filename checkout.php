...
if(isset($_POST['order'])){
   ...
   //test methods
   /*if($check_cart->rowCount() > 0 && $check_method == stripe){
...
<!-- /* btn paypal -->
     ...
     <!-- <input type="submit" name="order" class="btn <?= ($grand_total > 1)?'':'disabled'; ?>" value="paypal"> -->


   </form>
   
   
   <a href="payment/form.html" class="btn <?= ($grand_total > 1)?'':'disabled'; ?>">paypal</a>
